...
export function CheckBadgeIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function TwitterXIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.736-8.849L2 2.25h6.945l4.265 5.638 5.034-5.638zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
    </svg>
  );
}
